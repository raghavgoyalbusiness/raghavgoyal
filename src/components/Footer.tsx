import { Instagram, Linkedin, Globe, Briefcase } from 'lucide-react';
            ...
            {socialLinks.map((l) => {
              ...
              return (
                <a
                  ...
                  className="group flex items-center gap-2 rounded-full border border-border bg-surface/40 px-4 py-2 text-xs text-foreground/60 hover:border-primary/60 hover:text-primary hover:bg-surface transition-all"
                >
